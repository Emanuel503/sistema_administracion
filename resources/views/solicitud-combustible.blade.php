...
@include('layouts.mensajesSolicitudCombustible')
            ...
            <div class="modal-body">
                <form action="{{ route('solicitud-combustible.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="fecha_solicitud" id="fecha_solicitud" value="{{ old('fecha_solicitud') }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="fecha_detalle" id="fecha_detalle" value="{{ old('fecha_detalle') }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="cantidad_combustible" id="cantidad_combustible" value="{{ old('cantidad_combustible') }}">
                    </div>
            </div>
