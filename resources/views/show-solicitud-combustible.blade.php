...
@section('content')
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="lugar_destino" id="lugar_destino" value="{{$solicitudes->tipo_combustible}}" readonly>
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="fecha_registro" id="fecha_registro" value="{{$solicitudes->updated_at}}" readonly>
    </div>
