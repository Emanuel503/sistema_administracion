...
@section('content')
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="fecha_registro" id="fecha_registro" value="{{$solicitudesSala->updated_at}}" readonly>
    </div>

    @if(Auth::user()->rol->id == $solicitudesSala->usuario->id)
        @if ($solicitudesSala->autorizacion->id == 3)
